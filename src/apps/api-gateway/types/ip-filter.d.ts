export declare type IpFilter = {
  /**
   * IP addresses or CIDR ranges (IPv4, IPv6, or CIDR ranges (IPv4 and IPv6)) that are explicitly allowed.
  ...
  /**
   * IP addresses or CIDR ranges (IPv4, IPv6, or CIDR ranges (IPv4 and IPv6)) that are explicitly blocked.
