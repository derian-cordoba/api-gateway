    ...
    <main className="editor-page">
      <header className="editor-header">
        <div className="editor-header__identity">
          ...
          <div>
            <span className="eyebrow">{index === null ? "New route" : "Editing route"}</span>
            <h1>{route.baseURL || "Untitled route"}</h1>
          </div>
        </div>
      ...
      <div className="editor-layout">
        ...
        <aside className="route-summary">
          ...
          <dl>
            ...
            <div>
              <dt>Features</dt>
              <dd>{enabledSections.size - 1} enabled</dd>
            </div>
          </dl>
