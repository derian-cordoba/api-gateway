import { GatewaysSchema } from "./validation/gateway.schema";
import type { ConfigurationWarning, GatewayRoute } from "./types";
...
export function validateConfiguration(input: unknown): ValidationResult {
  ...
  const duplicate = findRoutePrefixConflicts(parsed.data).find(
